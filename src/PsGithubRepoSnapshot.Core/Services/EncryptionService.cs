...
public static class EncryptionService
{
    ...
    public static async Task<string> Encrypt(string clearText)
    {
        ...
        await using (var cs = new CryptoStream(ms, crypto.CreateEncryptor(), CryptoStreamMode.Write))
        {
    ...
    public static async Task<string> Decrypt(string cipherText)
    {
        ...
        await using var ms = new MemoryStream();
        await using (var cs = new CryptoStream(ms, crypto.CreateDecryptor(), CryptoStreamMode.Write))
        {
