...
public class NewGithubRepoSnapshotCmdlet : BaseGithubRepoSnapshotCmdlet
{
    ...
    protected override void EndProcessing()
    {
        try
        {
            ...
            var repos = Task.Run(async () => await GithubService.GetRepositories(filter)).Result;
            ...
            foreach (var repo in repos)
            {
                ...
                var task = GithubService.DownloadAndExtractRepository(repo, outputDir, branch, ExtractArchive.IsPresent);
